...
$username=checkUser($_SESSION['clientid'],session_id(),0);
			...
			<?php
				...
				foreach($images as $curimg){
					if(!in_array($curimg, $ignore)) {
						echo "<li id="gallery"><a href='".$dirname.$curimg."'><img src='img.php?src=".$dirname.$curimg."&w=300&zc=1' alt='' /></a></li>n ";
					}
				}                 
			?>
		</ul>
